            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                        <b>Name</b><a class="float-right" id="name1"></a>
                    </li>

                    <li class="list-group-item">
                        <b>Type</b><a class="float-right" id="type1"></a>
                    </li>
                ...
                <a href="../indexadmin.php?page=listuser" class="btn btn-primary"><b>Back</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
...
<?php include "../templates/footersd2.php" ?>
