...
<div class="content-wrapper">
  ...
  <div class="card">
    ...
    <div class="pull-right">
      <a class="btn btn-danger" href="../indexcsm.php?page=outlet" style="margin-left: 20px; margin-bottom: 50px"> Back </a>
      <!-- <a class="btn btn-primary" href="#" style="margin-left: 1075px; margin-top: 20px;" id="export"> Export </a> -->
    </div>
  </div>
</div>
<?php include "footeroutletreport_csm.php" ?>