        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item has-treeview">
            <a href="../indexcsm.php?page=dashboard" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="../indexcsm.php?page=laporan" class="nav-link">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../indexcsm.php?page=listuser" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List User</p>
                </a>
              <li class="nav-item">
                <a href="../indexcsm.php?page=createuser" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create User</p>
                </a>
              </li>
